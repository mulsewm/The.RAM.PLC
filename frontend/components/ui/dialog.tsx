  ...
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ...
      className={cn(
        ...
        "h-screen w-screen overflow-y-auto sm:h-auto sm:max-h-[85vh] sm:max-w-lg sm:rounded-lg",
        "left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2",
        "border border-border/50 sm:border",
      ...
      onPointerDownOutside={(e) => {
        // Prevent dialog from closing when clicking inside the content on mobile
